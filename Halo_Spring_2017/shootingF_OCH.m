function [d,TE,T] = shootingF_OCH(X)
...
%[T,M,TE,IE]=ode45(@state_dot_OCH,TIMES_F,M0,options1);
[T,M,TE,IE]=ode45(@state_dot_OCH,[0,tf],M0,options1);
...
function S_dot=state_dot_OCH(t,S)
