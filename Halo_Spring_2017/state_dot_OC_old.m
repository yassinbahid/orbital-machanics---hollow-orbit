...
S_dot(5) = ( 1-((((S(1)-(1-u))^2+S(2)^2)*u-3*(u*S(1)+u)*(S(1)-(1-u)))/(r1^5))...
         - (((1-u)*((S(1)+u)^2+S(2)^2)^(1/2)*(-2*(S(1)+u)^2+S(2)^2))/(r1^6)) )*lam3...
         + ( -((-3*S(2)*(1-u)*(S(1)+u))/(r2^5)) - ((-3*u*S(2)*(S(1)-1+u))/(r1^5)) )*lam4;
S_dot(5) = -S_dot(5);
S_dot(6) = ( (3*S(2)*(u*S(1)+u))/(r1^5) + (3*S(2)*(1-u)*(S(1)+u))/(r2^5) )*lam3 ...
        + ( -((1-u)*((r2^3)-3*S(2)^2*r1))/(r1^6)...
        - ((S(1)-(1-u))^2-2*S(2)^2)/(r1^5) )*lam4;
S_dot(6) = -S_dot(6);
S_dot(7) = lam1 - 2*lam4;
S_dot(7) = -S_dot(7);
S_dot(8) = lam2 + 2*lam3;
