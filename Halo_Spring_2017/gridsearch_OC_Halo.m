function [Xbest, dbest, FinPt,DDS] = gridsearch_OC_Halo(c1_int,n1,c2_int,n2,k1_int,n3,k2_int,n4,tf_int,n5)
    ...
    for j=1:n2+1
        ...
        for l=1:n3+1
            ...
            for m=1:n4+1
                ...
                X= [c1,c2,k1,k2,tf]';
                [d,TE,TS] = shootingF_OCH(X);% dd = norm(d);%, ls = ls +1;,DDS(ls) = dd;
